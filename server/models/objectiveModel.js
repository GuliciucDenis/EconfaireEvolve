...
const objectiveSchema = new mongoose.Schema({
  ...
  gradeAdmin: { type: Number, min: 0, max: 10, default: 1 }, // Overall grade given by admin
  gradeEmployee: { type: Number, min: 0, max: 10, default: 1 }, // Overall grade given by employee
  status: {
    type: String,
    required: true,
